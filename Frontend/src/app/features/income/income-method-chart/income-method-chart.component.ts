...
@Component({
  selector: 'app-income-method-chart',
  standalone: true,
  imports: [CommonModule, NgChartsModule],
  templateUrl: './income-method-chart.component.html',
  styleUrls: ['./income-method-chart.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class IncomeMethodChartComponent implements OnChanges {
  ...
  constructor( private meta: Meta) {
    this.meta.addTags([
      { name: 'description', content: 'Visual breakdown of this month’s income categorized by payment method in Alpha Vault.' },
