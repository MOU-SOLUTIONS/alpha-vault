...
import { IncomeEvaluationMetricsComponent } from './income-evaluation-metrics.component';

describe('IncomeEvaluationMetricsComponent', () => {
  let component: IncomeEvaluationMetricsComponent;
  let fixture: ComponentFixture<IncomeEvaluationMetricsComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [IncomeEvaluationMetricsComponent, DecimalPipe]
    })
    .compileComponents();

    fixture = TestBed.createComponent(IncomeEvaluationMetricsComponent);
  ...
  it('should display metric titles correctly', () => {
    ...
    expect(metricTitles[0].textContent).toBe('Income Efficiency');
  ...
  it('should have proper ARIA labels for metric rows', () => {
    ...
    const metricRows = fixture.debugElement.nativeElement.querySelectorAll('.metric-row');
    expect(metricRows[0].getAttribute('aria-label')).toBe('Income Efficiency: 85.5%');
