/*
  ...
  @description Comprehensive tests for expense table paginator component
*/
...
import { ExpenseTablePaginatorComponent } from './expense-table-paginator.component';

/* ===== TEST SUITE ===== */
describe('ExpenseTablePaginatorComponent', () => {
  let component: ExpenseTablePaginatorComponent;
  let fixture: ComponentFixture<ExpenseTablePaginatorComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(ExpenseTablePaginatorComponent);
  ...
  it('should have proper ARIA attributes', () => {
    ...
    expect(paginator.nativeElement.getAttribute('aria-label')).toBe('Expense table pagination');
  });
