...
/* ===== COMPONENT ===== */
@Component({
  selector: 'app-expense-evaluation-metrics',
  standalone: true,
    ...
    <section class="metrics-section" role="region" aria-labelledby="metrics-title">
      ...
      <div class="metrics-list">
        <article class="metric-row" 
                 tabindex="0" 
                 role="button"
                 [attr.aria-label]="'Expense Efficiency: ' + efficiency + '%'"
          ...
          <div class="metric-info">
            ...
            <div class="metric-score">
              <div class="score-bar" role="progressbar" [attr.aria-valuenow]="efficiency" aria-valuemin="0" aria-valuemax="100" [attr.aria-label]="'Expense Efficiency: ' + efficiency + '%'">
  ...
  `,
  styleUrls: ['./expense-evaluation-metrics.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ExpenseEvaluationMetricsComponent {
  /* ===== INPUTS ===== */
  @Input() efficiency = 0;
