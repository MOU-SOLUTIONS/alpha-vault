...
import { IncomeEvaluationInsightsComponent, Insight } from './income-evaluation-insights.component';

describe('IncomeEvaluationInsightsComponent', () => {
  let component: IncomeEvaluationInsightsComponent;
  let fixture: ComponentFixture<IncomeEvaluationInsightsComponent>;
  ...
  const mockInsights: Insight[] = [
    {
      ...
      description: 'Your income has grown 15.5% this month. Keep up the excellent work!'
    },
    {
      id: 2,
      icon: '🌐',
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [IncomeEvaluationInsightsComponent]
    })
    .compileComponents();

    fixture = TestBed.createComponent(IncomeEvaluationInsightsComponent);
  ...
  it('should display insights correctly', () => {
    ...
    expect(titles[2].textContent).toBe('Stable Income Pattern');

    const descriptions = fixture.debugElement.nativeElement.querySelectorAll('.insight-content p');
    expect(descriptions[0].textContent).toContain('Your income has grown 15.5%');
