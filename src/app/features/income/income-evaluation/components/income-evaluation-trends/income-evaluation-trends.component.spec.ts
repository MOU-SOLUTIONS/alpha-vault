/*
  ...
  @component IncomeEvaluationTrendsComponent
  @description Income evaluation trends component for displaying income data
*/

import { DecimalPipe } from '@angular/common';
import { ComponentFixture, ComponentFixtureAutoDetect, TestBed } from '@angular/core/testing';

import { IncomeEvaluationTrendsComponent } from './income-evaluation-trends.component';

describe('IncomeEvaluationTrendsComponent', () => {
  let component: IncomeEvaluationTrendsComponent;
  let fixture: ComponentFixture<IncomeEvaluationTrendsComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [IncomeEvaluationTrendsComponent, DecimalPipe],
      providers: [
    ...
    fixture = TestBed.createComponent(IncomeEvaluationTrendsComponent);
