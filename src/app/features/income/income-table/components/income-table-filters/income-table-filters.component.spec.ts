/*
  ...
  @component IncomeTableFiltersComponent
  @description Income table filters component for displaying income data
*/
...
import { IncomeTableFiltersComponent } from './income-table-filters.component';

describe('IncomeTableFiltersComponent', () => {
  let component: IncomeTableFiltersComponent;
  let fixture: ComponentFixture<IncomeTableFiltersComponent>;
  ...
  beforeEach(async () => {
    ...
    fixture = TestBed.createComponent(IncomeTableFiltersComponent);
  ...
  it('should have proper form labels and inputs', () => {
    ...
    const receivedSelect = fixture.debugElement.query(By.css('#received'));
    ...
    expect(receivedSelect.nativeElement.getAttribute('aria-label')).toBe('Filter by received status');
  });
