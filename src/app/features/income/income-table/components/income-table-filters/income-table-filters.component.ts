...
/* ===== COMPONENT DECORATOR ===== */
@Component({
  selector: 'app-income-table-filters',
  standalone: true,
  ...
  template: `
    ...
    >
      ...
      <div class="col-12 col-md-12">
          <mat-form-field appearance="outline" class="w-100">
            ...
            <input
              ...
              placeholder="e.g. Salary, Week, 2025"
      ...
      <div class="row g-1">
        ...
        <div class="col-12 col-md-3">
          <div class="select-input-wrapper">
            <label class="select-label" for="received">Received</label>
            <mat-select 
              id="received"
              formControlName="received"
              class="select-input"
              aria-label="Filter by received status">
              <mat-option value="">All</mat-option>
  ...
  `,
  styleUrls: ['./income-table-filters.component.scss']
})
export class IncomeTableFiltersComponent {
  /* ===== INPUTS ===== */
